        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="text-center">
                    ...
                    @if (session('expired'))
                        <h2 class="text-danger my-4">Password has expired. Please create a new password.</h2>
                    @elseif(session('first_login'))
                        <h2 class="text-danger my-4">Please change your default password.</h2>
                    @else
                        <h2 class="text-danger my-4">Please change your password to get access to the portal.</h2>
                    @endif
