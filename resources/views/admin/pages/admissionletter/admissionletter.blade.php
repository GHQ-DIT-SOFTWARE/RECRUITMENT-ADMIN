            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Admission Letter </h5>
                    </div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="feather icon-home"></i></a></li>
                        <li class="breadcrumb-item"><a href="#">Admission Letter</a></li>
                        <li class="breadcrumb-item"><a href="#">Reprinting</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-header border-0">
                    <nav class="navbar justify-content-between p-0 align-items-center">
                        <h5>Reprint Admission Letter</h5>
                    </nav>
                </div>
            </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#main-vettings').DataTable({
                ...
                ajax: {
                    url: "{{ route('api-reprint-admission-letter-applicant') }}",
                    type: 'POST',
                    headers: {
