...
@section('content')
            ...
            <div class="card">
                <div class="card-header border-0">
                    <nav class="navbar justify-content-between p-0 align-items-center">
                        <h5>FILTER APPLICANT FOR CORRECTIONS</h5>
                    </nav>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row align-items-center m-l-0">
                        <div class="dt-responsive table-responsive">
                            <table id="applicant-preview" class="table table-striped table-bordered nowrap">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>SURNAME</th>
    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#applicant-preview').DataTable({
                ...
                ajax: {
                    url: "{{ route('generate-applicant-correction') }}",
                    type: 'POST',
                    headers: {
