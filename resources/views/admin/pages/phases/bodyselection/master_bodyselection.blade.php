            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h5 class="m-b-10">General Body Selection Reporting </h5>
                    </div>
                    <ul class="breadcrumb">
            ...
            <div class="card">
                <div class="card-header border-0">
                    <nav class="navbar justify-content-between p-0 align-items-center">
                        <h5>REPORT GENERATION-BODY SELECTION</h5>
                    </nav>
                </div>
            </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="form-group form-focus">
                                        <select class="form-control select2" name="qualification">
                                            ...
                                            @foreach ($data->unique('body_selection_status') as $status)
                                                <option value="{{ $status->body_selection_status }}">
                                                    {{ $status->body_selection_status }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#main-vettings').DataTable({
                ...
                ajax: {
                    url: "{{ route('api-master-bodyselection') }}",
                    type: 'POST',
                    headers: {
                ...
                columns: [{
                    ...
                    {
                        data: 'body_selection_status',
                        name: 'body_selection_status'
                    },
                    {
                        data: 'action',
                        name: 'action'
