        ...
        <div class="col-md-12 order-md-2">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{ route('test.status-save-aptitude-test', $applied_applicant->uuid) }}">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="aptitude_marks" placeholder="marks">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
