    ...
    <div class="row">
        <div class="col-md-12 order-md-2">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('test.vetting-update', $vettings->uuid) }}">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <select class="custom-select" name="vetting_status" required>
                                    ...
                                    <option value="QUALIFIED"
                                        {{ $vettings->vetting_status == 'QUALIFIED' ? 'selected' : '' }}>
                                        QUALIFIED</option>
                                    <option value="DISQUALIFIED"
                                        {{ $vettings->vetting_status == 'DISQUALIFIED' ? 'selected' : '' }}>
                                        DISQUALIFIED</option>

                                    <option value="PENDING" {{ $vettings->vetting_status == 'PENDING' ? 'selected' : '' }}>
                                        PENDING</option>
                                </select>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <textarea class="form-control" name="vetting_remarks" placeholder="Remarks">{{ old('vetting_remarks', $vettings->vetting_remarks) }}</textarea>
                                </div>
                            </div>
                        </div>
