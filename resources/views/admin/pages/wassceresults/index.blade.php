                    ...
                    <div class="row align-items-center m-l-0">
                        ...
                        <div class="col-sm-6 text-right"><br />
                            <div class="btn-group mb-2 mr-2" style="display: inline-block;">
                                <a href="{{ route('results.mech-wassce-results') }}" class="btn  btn-primary "
                                ...
                                <table id="example" class="table table-striped table-bordered nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>WASSCE RESULTS</th>
                                            <th width="20%">ACTION</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($wassce as $key => $record)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                <td>
                                                    {{ $record->wassceresult }}
                                                ...
                                                <td>
                                                    <a class="btn btn-danger btn-sm"
                                                        href="{{ route('results.delete-wassce-results', $record->uuid) }}"
